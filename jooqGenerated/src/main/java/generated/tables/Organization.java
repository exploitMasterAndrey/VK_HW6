...
public class Organization extends TableImpl<OrganizationRecord> {
    ...
    /**
     * The column <code>public.organization.org_name</code>.
     */
    public final TableField<OrganizationRecord, String> ORG_NAME = createField(DSL.name("org_name"), SQLDataType.VARCHAR(50).nullable(false), this, "");
