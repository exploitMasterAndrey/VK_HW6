...
public class Product extends TableImpl<ProductRecord> {
    ...
    /**
     * The column <code>public.product.prod_name</code>.
     */
    public final TableField<ProductRecord, String> PROD_NAME = createField(DSL.name("prod_name"), SQLDataType.VARCHAR(50).nullable(false), this, "");

    /**
     * The column <code>public.product.inner_code</code>.
     */
    public final TableField<ProductRecord, Integer> INNER_CODE = createField(DSL.name("inner_code"), SQLDataType.INTEGER.nullable(false), this, "");
